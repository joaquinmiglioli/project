...
public class ParkingFine extends Fine {
    ...
    private final int toleranceSec; // tolerancia en zona prohibida
    private final int parkedSec;    // tiempo real estacionado
    ...
    public void compute() {
        ...
        if (parkedSec > toleranceSec && toleranceSec > 0) {
            ...
            amount += 2000.0 * blocks5min;      // $2000 por bloque (ajustable)
        }
